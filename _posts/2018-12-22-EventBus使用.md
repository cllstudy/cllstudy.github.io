...
![eventbus](https://assets-1255846797.cos.ap-chengdu.myqcloud.com/IMAGE/blog/EventBus.png)
...
> 3.0 后引入了索引加速(默认不开启)的功能，即通过 apt 编译插件的方式，在代码编译的时候对注>       解进行索引，避免了以往通过反射造成的性能损耗。
