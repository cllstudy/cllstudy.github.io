...
* 主页: [https://github.com/JakeWharton/butterknife](https://github.com/JakeWharton/butterknife)
* 用途: 主要用来简化各种初始化控件的操作
* 配置:
...
![androidAnnatations_app.png](http://www.wailian.work/images/2018/12/12/androidAnnatations_app.png)
